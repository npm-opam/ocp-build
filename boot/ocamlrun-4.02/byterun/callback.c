...
static opcode_t callback_code[] = { ACC, 0, APPLY, 0, POP, 1, STOP, FIRST_UNIMPLEMENTED_OP };
#endif
...
CAMLexport value caml_callbackN_exn(value closure, int narg, value args[])
{
  ...
  opcode_t local_callback_code[8];
#endif
  ...
  local_callback_code[7] = FIRST_UNIMPLEMENTED_OP;
#ifdef THREADED_CODE
