...
#ifndef NATIVE_CODE
#define Caml1999X008 0
#define Caml1999X010 1
extern int bytecode_compatibility;
CAMLextern char * Caml1999X008_caml_format_exception(value exn);
CAMLextern void Caml1999X008_caml_raise_constant(value tag) Noreturn;
CAMLextern void Caml1999X008_caml_raise_out_of_memory(void) Noreturn;
#endif
